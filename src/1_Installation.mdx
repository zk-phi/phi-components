...
## As a framework-agnostic custom elements (Web Components)
### Minimal installation (UMD)

Copy `dist/custom-elements.umd.js` to your project.
...
### ES Modules (without package manager)

Copy `dist/custom-elements.js` to your project.
...
``` html
<script type="module">
  import registerPhiComponents from "./phi-components.js";
  registerPhiComponents();
</script>
```
