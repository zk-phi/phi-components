...
function pe(t, e, r, i, l, o, a, s, _, p, c) {
  var n, g, h, b, m, v, d = i && i.__k || ae, u = e.length;
  for (_ = me(r, e, d, _, u), n = 0; n < u; n++) (h = r.__k[n]) != null && (g = h.__i == -1 ? N : d[h.__i] || N, h.__i = n, v = G(t, h, g, l, o, a, s, _, p, c), b = h.__e, h.ref && g.ref != h.ref && (g.ref && Y(g.ref, null, h), c.push(h.ref, h.__c || b, h)), m == null && b != null && (m = b), 4 & h.__u || g.__k === h.__k ? _ = _e(h, _, t) : typeof h.type == "function" && v !== void 0 ? _ = v : b && (_ = b.nextSibling), h.__u &= -7);
  return r.__e = m, _;
}
function me(t, e, r, i, l) {
  var o, a, s, _, p, c = r.length, n = c, g = 0;
  for (t.__k = new Array(l), o = 0; o < l; o++) (a = e[o]) != null && typeof a != "boolean" && typeof a != "function" ? (_ = o + g, (a = t.__k[o] = typeof a == "string" || typeof a == "number" || typeof a == "bigint" || a.constructor == String ? E(null, a, null, null, null) : I(a) ? E(O, { children: a }, null, null, null) : a.constructor == null && a.__b > 0 ? E(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a).__ = t, a.__b = t.__b + 1, s = null, (p = a.__i = ye(a, r, _, n)) != -1 && (n--, (s = r[p]) && (s.__u |= 2)), s == null || s.__v == null ? (p == -1 && (l > c ? g-- : l < c && g++), typeof a.type != "function" && (a.__u |= 4)) : p != _ && (p == _ - 1 ? g-- : p == _ + 1 ? g++ : (p > _ ? g-- : g++, a.__u |= 4))) : t.__k[o] = null;
  if (n) for (o = 0; o < c; o++) (s = r[o]) != null && (2 & s.__u) == 0 && (s.__e == i && (i = P(s)), de(s, s));
  return i;
}
function _e(t, e, r) {
  var i, l;
...
function ye(t, e, r, i) {
  var l, o, a = t.key, s = t.type, _ = e[r];
  if (_ === null && t.key == null || _ && a == _.key && s == _.type && (2 & _.__u) == 0) return r;
  if (i > (_ != null && (2 & _.__u) == 0 ? 1 : 0)) for (l = r - 1, o = r + 1; l >= 0 || o < e.length; ) {
    if (l >= 0) {
      if ((_ = e[l]) && (2 & _.__u) == 0 && a == _.key && s == _.type) return l;
      l--;
    }
    if (o < e.length) {
      if ((_ = e[o]) && (2 & _.__u) == 0 && a == _.key && s == _.type) return o;
      o++;
    }
  }
  return -1;
...
function G(t, e, r, i, l, o, a, s, _, p) {
  ...
  e: if (typeof y == "function") try {
    ...
    if (n.context = w, n.props = d, n.__P = t, n.__e = !1, z = f.__r, J = 0, u) {
      for (n.state = n.__s, n.__d = !1, z && z(e), c = n.render(n.props, n.state, n.context), L = 0; L < n._sb.length; L++) n.__h.push(n._sb[L]);
      n._sb = [];
    } else do
      n.__d = !1, z && z(e), c = n.render(n.props, n.state, n.context), n.state = n.__s;
    while (n.__d && ++J < 25);
    n.state = n.__s, n.getChildContext != null && (i = k(k({}, i), n.getChildContext())), u && !g && n.getSnapshotBeforeUpdate != null && (m = n.getSnapshotBeforeUpdate(h, b)), A = c, c != null && c.type === O && c.key == null && (A = he(c.props.children)), s = pe(t, I(A) ? A : [A], e, r, i, l, o, a, s, _, p), n.base = e.__e, e.__u &= -161, n.__h.length && a.push(n), v && (n.__E = n.__ = null);
  } catch (M) {
    if (e.__v = null, _ || o != null) if (M.then) {
  ...
  else o == null && e.__v == r.__v ? (e.__k = r.__k, e.__e = r.__e) : s = e.__e = ke(r.__e, e, r, i, l, o, a, _, p);
  return (c = f.diffed) && c(e), 128 & e.__u ? void 0 : s;
}
function ce(t, e, r) {
...
function ke(t, e, r, i, l, o, a, s, _) {
  var p, c, n, g, h, b, m, v = r.props, d = e.props, u = e.type;
  ...
  if (u == null) v === d || s && t.data == d || (t.data = d);
    ...
    for (p in d) h = d[p], p == "children" ? g = h : p == "dangerouslySetInnerHTML" ? c = h : p == "value" ? b = h : p == "checked" ? m = h : s && typeof h != "function" || v[p] === h || $(t, p, h, v[p], l);
    if (c) s || n && (c.__html == n.__html || c.__html == t.innerHTML) || (t.innerHTML = c.__html), e.__k = [];
    else if (n && (t.innerHTML = ""), pe(e.type == "template" ? t.content : t, I(g) ? g : [g], e, r, i, u == "foreignObject" ? "http://www.w3.org/1999/xhtml" : l, o, a, o ? o[0] : r.__k && P(r, 0), s, _), o != null) for (p = o.length; p--; ) q(o[p]);
...
function H(t, e, r) {
  var i, l, o, a;
  e == document && (e = document.documentElement), f.__ && f.__(t, e), l = (i = typeof r == "function") ? null : r && r.__k || e.__k, o = [], a = [], G(e, t = (!i && r || e).__k = T(O, null, [t]), l || N, N, e.namespaceURI, !i && r ? [r] : l ? null : e.firstChild ? U.call(e.childNodes) : null, o, !i && r ? r : l ? l.__e : e.firstChild, i, a), ce(o, t, a);
}
function ue(t, e) {
  H(t, e, ue);
}
...
function ee(t, e, r, i, l, o) {
  e || (e = {});
  var a, s, _ = e;
  if ("ref" in _) for (s in _ = {}, e) s == "ref" ? a = e[s] : _[s] = e[s];
  var p = { type: t, props: _, key: r, ref: a, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --Se, __i: -1, __u: 0, __source: l, __self: o };
  if (typeof t == "function" && (a = t.defaultProps)) for (s in a) _[s] === void 0 && (_[s] = a[s]);
...
const Pe = ({
  ...
  class r extends HTMLElement {
    ...
    parseAttribute(o, a, s) {
      var _, p;
      if (!(s && ((_ = this._initialProps) != null && _.hasOwnProperty(o))) && (p = e.attributes) != null && p[o]) {
        const c = e.attributes[o], n = "parse" in c ? c.parse : c;
    ...
    connectedCallback() {
      ...
      for (let c = 0; c < o.length; c++)
        this.parseAttribute(o[c].name, o[c].value, !0);
      const s = this._initialProps ?? {}, _ = Object.fromEntries(
        (e.slots ?? []).map((c) => [c, T(re, { name: c }, null)])
      ), p = { $element: this, ...s, ..._ };
  ...
  return x(r, "observedAttributes", Object.keys(e.attributes ?? {})), x(r, "formAssociated", !!e.formAssociated), (e.properties ?? []).forEach((i) => {
    ...
    Object.defineProperty(r.prototype, i, {
      ...
      set(_) {
        this.updateProp(i, _), a && this.setAttribute(i, a(_)), l && this._internals && this._internals.setFormValue(_);
      }
    });
  }), r;
};
