...
var q = (e, t, r) => Ge(e, typeof t != "symbol" ? t + "" : t, r);
var I, g, Te, P, ge, Ee, Ve, qe, he, le, se, O = {}, Ae = [], Je = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, ee = Array.isArray;
function H(e, t) {
...
function D(e, t, r) {
  var o, i, n, l = {};
  for (n in t) n == "key" ? o = t[n] : n == "ref" ? i = t[n] : l[n] = t[n];
  if (arguments.length > 2 && (l.children = arguments.length > 3 ? I.call(arguments, 2) : r), typeof e == "function" && e.defaultProps != null) for (n in e.defaultProps) l[n] == null && (l[n] = e.defaultProps[n]);
  return U(e, l, o, i, null);
}
...
function fe(e) {
  (!e.__d && (e.__d = !0) && P.push(e) && !Q.__r++ || ge != g.debounceRendering) && ((ge = g.debounceRendering) || Ee)(Q);
}
function Q() {
  for (var e, t, r, o, i, n, l, c = 1; P.length; ) P.length > c && P.sort(Ve), e = P.shift(), c = P.length, e.__d && (r = void 0, i = (o = (t = e).__v).__e, n = [], l = [], t.__P && ((r = H({}, o)).__v = o.__v + 1, g.vnode && g.vnode(r), ue(t.__P, r, o, t.__n, t.__P.namespaceURI, 32 & o.__u ? [i] : null, n, i ?? L(o), !!(32 & o.__u), l), r.__v = o.__v, r.__.__k[r.__i] = r, Ne(n, r, l), r.__e != i && Pe(r)));
  Q.__r = 0;
}
function We(e, t, r, o, i, n, l, c, h, p, u) {
  var a, _, d, v, y, b, m = o && o.__k || Ae, f = t.length;
  for (h = Ke(r, t, m, h, f), a = 0; a < f; a++) (d = r.__k[a]) != null && (_ = d.__i == -1 ? O : m[d.__i] || O, d.__i = a, b = ue(e, d, _, i, n, l, c, h, p, u), v = d.__e, d.ref && _.ref != d.ref && (_.ref && _e(_.ref, null, d), u.push(d.ref, d.__c || v, d)), y == null && v != null && (y = v), 4 & d.__u || _.__k === d.__k ? h = Le(d, h, e) : typeof d.type == "function" && b !== void 0 ? h = b : v && (h = v.nextSibling), d.__u &= -7);
  return r.__e = y, h;
}
function Ke(e, t, r, o, i) {
  var n, l, c, h, p, u = r.length, a = u, _ = 0;
  for (e.__k = new Array(i), n = 0; n < i; n++) (l = t[n]) != null && typeof l != "boolean" && typeof l != "function" ? (h = n + _, (l = e.__k[n] = typeof l == "string" || typeof l == "number" || typeof l == "bigint" || l.constructor == String ? U(null, l, null, null, null) : ee(l) ? U(te, { children: l }, null, null, null) : l.constructor == null && l.__b > 0 ? U(l.type, l.props, l.key, l.ref ? l.ref : null, l.__v) : l).__ = e, l.__b = e.__b + 1, c = null, (p = l.__i = Qe(l, r, h, a)) != -1 && (a--, (c = r[p]) && (c.__u |= 2)), c == null || c.__v == null ? (p == -1 && (i > u ? _-- : i < u && _++), typeof l.type != "function" && (l.__u |= 4)) : p != h && (p == h - 1 ? _-- : p == h + 1 ? _++ : (p > h ? _-- : _++, l.__u |= 4))) : e.__k[n] = null;
  if (a) for (n = 0; n < u; n++) (c = r[n]) != null && (2 & c.__u) == 0 && (c.__e == o && (o = L(c)), Be(c, c));
  return o;
}
function Le(e, t, r) {
  var o, i;
  if (typeof e.type == "function") {
    for (o = e.__k, i = 0; o && i < o.length; i++) o[i] && (o[i].__ = e, t = Le(o[i], t, r));
    return t;
  }
  e.__e != t && (t && e.type && !r.contains(t) && (t = L(e)), r.insertBefore(e.__e, t || null), t = e.__e);
  do
    t = t && t.nextSibling;
...
function Qe(e, t, r, o) {
  var i, n, l = e.key, c = e.type, h = t[r];
  if (h === null && e.key == null || h && l == h.key && c == h.type && (2 & h.__u) == 0) return r;
  if (o > (h != null && (2 & h.__u) == 0 ? 1 : 0)) for (i = r - 1, n = r + 1; i >= 0 || n < t.length; ) {
    if (i >= 0) {
      if ((h = t[i]) && (2 & h.__u) == 0 && l == h.key && c == h.type) return i;
      i--;
    }
    if (n < t.length) {
      if ((h = t[n]) && (2 & h.__u) == 0 && l == h.key && c == h.type) return n;
      n++;
    }
  }
  return -1;
...
function G(e, t, r, o, i) {
  ...
  else if (t[0] == "o" && t[1] == "n") n = t != (t = t.replace(qe, "$1")), l = t.toLowerCase(), t = l in e || t == "onFocusOut" || t == "onFocusIn" ? l.slice(2) : t.slice(2), e.l || (e.l = {}), e.l[t + n] = r, r ? o ? r.u = o.u : (r.u = he, e.addEventListener(t, n ? se : le, n)) : e.removeEventListener(t, n ? se : le, n);
  else {
...
function ue(e, t, r, o, i, n, l, c, h, p) {
  var u, a, _, d, v, y, b, m, f, N, V, Z, j, me, Y, B, re, S = t.type;
  if (t.constructor != null) return null;
  128 & r.__u && (h = !!(32 & r.__u), n = [c = t.__e = r.__e]), (u = g.__b) && u(t);
  e: if (typeof S == "function") try {
    if (m = t.props, f = "prototype" in S && S.prototype.render, N = (u = S.contextType) && o[u.__c], V = u ? N ? N.props.value : u.__ : o, r.__c ? b = (a = t.__c = r.__c).__ = a.__E : (f ? t.__c = a = new S(m, V) : (t.__c = a = new J(m, V), a.constructor = S, a.render = et), N && N.sub(a), a.props = m, a.state || (a.state = {}), a.context = V, a.__n = o, _ = a.__d = !0, a.__h = [], a._sb = []), f && a.__s == null && (a.__s = a.state), f && S.getDerivedStateFromProps != null && (a.__s == a.state && (a.__s = H({}, a.__s)), H(a.__s, S.getDerivedStateFromProps(m, a.__s))), d = a.props, v = a.state, a.__v = t, _) f && S.getDerivedStateFromProps == null && a.componentWillMount != null && a.componentWillMount(), f && a.componentDidMount != null && a.__h.push(a.componentDidMount);
    else {
    ...
    if (a.context = V, a.props = m, a.__P = e, a.__e = !1, j = g.__r, me = 0, f) {
      for (a.state = a.__s, a.__d = !1, j && j(t), u = a.render(a.props, a.state, a.context), Y = 0; Y < a._sb.length; Y++) a.__h.push(a._sb[Y]);
      a._sb = [];
    } else do
      a.__d = !1, j && j(t), u = a.render(a.props, a.state, a.context), a.state = a.__s;
    while (a.__d && ++me < 25);
    a.state = a.__s, a.getChildContext != null && (o = H(H({}, o), a.getChildContext())), f && !_ && a.getSnapshotBeforeUpdate != null && (y = a.getSnapshotBeforeUpdate(d, v)), B = u, u != null && u.type === te && u.key == null && (B = je(u.props.children)), c = We(e, ee(B) ? B : [B], t, r, o, i, n, l, c, h, p), a.base = t.__e, t.__u &= -161, a.__h.length && l.push(a), b && (a.__E = a.__ = null);
  } catch (F) {
  ...
  else n == null && t.__v == r.__v ? (t.__k = r.__k, t.__e = r.__e) : c = t.__e = Xe(r.__e, t, r, o, i, n, l, h, p);
...
function je(e) {
  return typeof e != "object" || e == null || e.__b && e.__b > 0 ? e : ee(e) ? e.map(je) : H({}, e);
}
function Xe(e, t, r, o, i, n, l, c, h) {
  ...
  if (f == null) b === m || c && e.data == m || (e.data = m);
    ...
    else if (a && (e.innerHTML = ""), We(t.type == "template" ? e.content : e, ee(_) ? _ : [_], t, r, o, f == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, n, l, n ? n[0] : r.__k && L(r, 0), c, h), n != null) for (p = n.length; p--; ) de(n[p]);
...
function oe(e, t, r) {
  var o, i, n, l;
  t == document && (t = document.documentElement), g.__ && g.__(e, t), i = (o = !1) ? null : t.__k, n = [], l = [], ue(t, e = t.__k = D(te, null, [e]), i || O, O, t.namespaceURI, i ? null : t.firstChild ? I.call(t.childNodes) : null, n, i ? i.__e : t.firstChild, o, l), Ne(n, e, l);
}
function tt(e, t, r) {
  var o, i, n, l, c = H({}, e.props);
  for (n in e.type && e.type.defaultProps && (l = e.type.defaultProps), t) n == "key" ? o = t[n] : n == "ref" ? i = t[n] : c[n] = t[n] == null && l != null ? l[n] : t[n];
  return arguments.length > 2 && (c.children = arguments.length > 3 ? I.call(arguments, 2) : r), U(e.type, c, o || e.key, i || e.ref, null);
}
I = Ae.slice, g = { __e: function(e, t, r, o) {
  for (var i, n, l; t = t.__; ) if ((i = t.__c) && !i.__) try {
    if ((n = i.constructor) && n.getDerivedStateFromError != null && (i.setState(n.getDerivedStateFromError(e)), l = i.__d), i.componentDidCatch != null && (i.componentDidCatch(e, o || {}), l = i.__d), l) return i.__E = i;
  } catch (c) {
    e = c;
  }
  throw e;
...
}, J.prototype.render = te, P = [], Ee = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, Ve = function(e, t) {
  return e.__v.__b - t.__v.__b;
}, Q.__r = 0, qe = /(PointerCapture)$|Capture$/i, he = 0, le = we(!1), se = we(!0);
var rt = 0;
function s(e, t, r, o, i, n) {
  t || (t = {});
  var l, c, h = t;
  if ("ref" in h) for (c in h = {}, t) c == "ref" ? l = t[c] : h[c] = t[c];
  var p = { type: e, props: h, key: r, ref: l, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --rt, __i: -1, __u: 0, __source: i, __self: n };
  if (typeof e == "function" && (l = e.defaultProps)) for (c in l) h[c] === void 0 && (h[c] = l[c]);
  return g.vnode && g.vnode(p), p;
}
const A = (e) => e && e !== "false" && e !== "0" || e === "", T = (e) => e == null ? "" : e.toString(), M = (e) => typeof e == "number" ? e : e == null || e === "" ? void 0 : typeof e == "string" ? Number(e) : Number.NaN, ne = (e) => (t) => M(t) ?? e, ot = (e) => e == null || e === "" ? [] : typeof e == "string" ? (
  // non-empty string
  e.split(",")
) : (
  // boolean or number
  ...
  ), l = Object.keys(n), c = (u = r.find((a) => a.formAssociated)) == null ? void 0 : u.name;
  class h extends HTMLElement {
    ...
    rerender() {
      this._frameRequested || requestAnimationFrame(() => {
        this._vdom && (this._frameRequested = !1, this._vdom = tt(this._vdom, this._props), oe(this._vdom, this._root));
      });
    }
    connectedCallback() {
      const d = Object.fromEntries(
        o.map((y) => [y, D(ye, { name: y }, null)])
      ), v = { $el: this, ...this._props, ...d };
  ...
  q(h, "observedAttributes", l), q(h, "formAssociated", !!c);
  for (const a of r)
...
), ft = ".phi-text-button{--phi-color-accent-default: var(--phi-color-neutral-default);--phi-color-accent-active: var(--phi-color-neutral-active);--phi-color-accent-bg: var(--phi-color-neutral-bg);display:inline;font-size:var(--phi-fontsize-md);cursor:pointer;-webkit-user-select:none;user-select:none;color:var(--phi-color-fg);background-color:transparent;border-bottom:1px dotted currentColor}.phi-text-button.danger{--phi-color-accent-default: var(--phi-color-danger-default);--phi-color-accent-active: var(--phi-color-danger-active);--phi-color-accent-bg: var(--phi-color-danger-bg)}.phi-text-button:hover:not(:active){color:var(--phi-color-accent-default)}.phi-text-button:active{color:var(--phi-color-accent-active);background-color:var(--phi-color-accent-bg)}", bt = k(ft), wt = ({ danger: e, children: t }) => /* @__PURE__ */ s(gt, { danger: e.value, children: t }), yt = () => z(wt, "phi-text-button", {
  adoptedStyleSheets: [$, bt],
  properties: [{
    name: "danger",
    attribute: { name: "danger", type: A }
  }]
}), xt = ({ gap: e, align: t = "left", style: r, children: o }) => /* @__PURE__ */ s("div", { class: `phi-group ${e} ${t}`, style: r, children: o }), kt = ".phi-group{display:flex;width:100%;flex-wrap:wrap}.phi-group.left{justify-content:flex-start}.phi-group.right{justify-content:flex-end}.phi-group.center{justify-content:center}.phi-group.space-between{justify-content:space-between}.phi-group.md{gap:var(--phi-spacing-margin-md)}.phi-group.sm{gap:var(--phi-spacing-margin-sm)}", zt = k(kt), $t = ({ gap: e, align: t, children: r }) => /* @__PURE__ */ s(xt, { gap: e.value, align: t.value, children: r }), Ct = () => z($t, "phi-group", {
  adoptedStyleSheets: [$, zt],
  properties: [{
    name: "gap",
    attribute: { name: "gap", type: E("md", ["sm"]) }
  }, {
    name: "align",
    attribute: { name: "align", type: E("left", ["center", "right", "space-between"]) }
  }]
}), St = ({ gap: e, style: t, children: r }) => /* @__PURE__ */ s("div", { class: `phi-stack ${e}`, style: t, children: r }), Ht = ".phi-stack{display:flex;width:100%;flex-direction:column}.phi-stack.md{gap:var(--phi-spacing-margin-md)}.phi-stack.sm{gap:var(--phi-spacing-margin-sm)}", Mt = k(Ht), Tt = ({ gap: e, children: t }) => /* @__PURE__ */ s(St, { gap: e.value, children: t }), Et = () => z(Tt, "phi-stack", {
  adoptedStyleSheets: [$, Mt],
  properties: [{
    name: "gap",
    attribute: { name: "gap", type: E("md", ["sm"]) }
  }]
...
function Vt(e, t, r) {
  ...
  if (o.t = e, !o.__c && (o.__ = [Ie(void 0, t), function(c) {
    ...
    w.__f = !0;
    var n = w.shouldComponentUpdate, l = w.componentWillUpdate;
...
x.__b = function(e) {
  ...
  $e && $e(e);
  var t = e.__c;
  t && t.__H && (t.__H.__h.length && (Ue.push(t) !== 1 && xe === x.requestAnimationFrame || ((xe = x.requestAnimationFrame) || Pt)(At)), t.__H.__.forEach(function(r) {
...
const ce = (e) => typeof e == "number" ? `${e}px` : e, Wt = ({
  ...
  properties: [{
    ...
    attribute: {
      name: "col-min-width",
      type: ie("min-content", ["max-content"])
    }
  }, {
    name: "colMaxWidth",
    attribute: {
  ...
  const [i, n] = Oe(() => document.body.clientWidth), l = W(() => t.sort((h, p) => p.width - h.width), [t]), c = W(() => (l.find((p) => p.width <= i) ?? { columns: [1] }).columns.map((p) => `${p}fr`).join(" "), [l, i]);
  return qt(() => {
    const h = () => {
...
}, Dt = ".phi-responsive-columns{display:grid;width:100%}.phi-responsive-columns.md{gap:var(--phi-spacing-margin-md)}.phi-responsive-columns.sm{gap:var(--phi-spacing-margin-sm)}", Ut = k(Dt), Ot = ({ gap: e, configuration: t, children: r }) => /* @__PURE__ */ s(
  Ft,
  {
    gap: e.value,
...
), Rt = () => z(Ot, "phi-responsive-columns", {
  adoptedStyleSheets: [$, Ut],
  properties: [{
    name: "gap",
    attribute: { name: "gap", type: E("md", ["sm"]) }
  }, {
...
), Zt = ".phi-responsive-container{display:block;min-height:100%;width:100%;margin:auto}.phi-responsive-container.md{padding:var(--phi-spacing-margin-md)}.phi-responsive-container.sm{padding:var(--phi-spacing-margin-sm)}", Yt = k(Zt), Gt = ({ padding: e, maxWidth: t, children: r }) => /* @__PURE__ */ s(It, { padding: e.value, maxWidth: t.value, children: r }), Jt = () => z(Gt, "phi-responsive-container", {
  adoptedStyleSheets: [$, Yt],
  properties: [{
    name: "padding",
    attribute: { name: "padding", type: E("md", ["sm"]) }
  }, {
    name: "maxWidth",
  ...
  return /* @__PURE__ */ s("label", { class: "phi-checkbox", style: r, children: [
    /* @__PURE__ */ s(
      "input",
      {
        type: "checkbox",
  ...
  const n = W(() => e.findIndex((c) => c === r) !== -1, [e, r]), l = C((c) => {
    c.currentTarget.checked ? t == null || t([...e, r], c) : t == null || t(e.filter((p) => p !== r), c);
  }, [e, r, t]);
  return /* @__PURE__ */ s("label", { class: "phi-checkbox", style: o, children: [
    /* @__PURE__ */ s(
      "input",
      {
        type: "checkbox",
...
}, rr = k(Ze), or = ({ $el: e, checked: t, value: r, children: o }) => {
  const i = C((n, l) => {
    l.stopPropagation(), t.value = n, e.dispatchEvent(new Event("change"));
  }, [e, t]);
  return /* @__PURE__ */ s(tr, { checked: t.value, value: r.value, onChange: i, children: o });
}, nr = () => z(or, "phi-option", {
  adoptedStyleSheets: [$, rr],
  properties: [{
    name: "checked",
    formAssociated: !0,
  ...
  const l = W(() => t === o, [t, o]), c = C((h) => {
    h.currentTarget.checked && (r == null || r(o, h));
  }, [o, r]);
  return /* @__PURE__ */ s("label", { class: "phi-radio", style: i, children: [
    /* @__PURE__ */ s(
      "input",
      {
        type: "radio",
  ...
  return /* @__PURE__ */ s(
    ...
    {
      type: "text",
      class: `phi-text-input ${l ? "error" : ""} ${n}`,
      placeholder: t,
      required: r,
      minlength: o,
      maxlength: i,
...
}, _r = () => z(ur, "phi-text-input", {
  adoptedStyleSheets: [$, dr],
  properties: [{
    name: "value",
    formAssociated: !0,
    attribute: { name: "value", type: T }
    ...
    name: "required",
    attribute: { name: "required", type: A }
  }, {
    name: "minlength",
    ...
    name: "size",
    attribute: { name: "size", type: E("md", ["sm"]) }
  }, {
    name: "error",
    attribute: { name: "error", type: A }
  }]
}), vr = ({
  value: e,
  placeholder: t = "",
  ...
  return /* @__PURE__ */ s(
    ...
    {
      type: "number",
      class: `phi-number-input ${l ? "error" : ""}`,
      placeholder: t,
      value: p,
      required: r,
      max: i,
...
}, br = () => z(fr, "phi-number-input", {
  adoptedStyleSheets: [$, gr],
  properties: [{
    name: "value",
    formAssociated: !0,
...
}, yr = ".phi-slider{width:100%;height:var(--phi-size-range-track);background:var(--phi-color-bg);border-radius:calc(var(--phi-size-range-track) / 2)}.phi-slider::-webkit-slider-runnable-track{height:var(--phi-size-range-track);border-radius:calc(var(--phi-size-range-track) / 2);border:1px solid var(--phi-color-border)}.phi-slider::-webkit-slider-thumb{-webkit-appearance:none;height:var(--phi-size-range-track);width:var(--phi-size-range-track);margin-top:-1px;transform:scale(var(--phi-size-range-thumb-scale));border:.5px solid var(--phi-color-border);border-radius:calc(var(--phi-size-range-track) / 2);background:var(--phi-color-bg);cursor:pointer}.phi-slider::-webkit-slider-thumb:hover{border-color:var(--phi-color-neutral-default)}.phi-slider::-webkit-slider-thumb:active{border-color:var(--phi-color-neutral-active);box-shadow:var(--phi-shadow-focus-neutral);transform:translateY(-1px) scale(var(--phi-size-range-thumb-scale))}.phi-slider::-moz-range-track{height:var(--phi-size-range-track);border-radius:calc(var(--phi-size-range-track) / 2);border:1px solid var(--phi-color-border)}.phi-slider::-moz-range-thumb{-webkit-appearance:none;height:var(--phi-size-range-track);width:var(--phi-size-range-track);transform:scale(var(--phi-size-range-thumb-scale));border:.5px solid var(--phi-color-border);border-radius:calc(var(--phi-size-range-track) / 2);background:var(--phi-color-bg);cursor:pointer}.phi-slider::-moz-range-thumb:hover{border-color:var(--phi-color-neutral-default)}.phi-slider::-moz-range-thumb:active{border-color:var(--phi-color-neutral-active);box-shadow:var(--phi-shadow-focus-neutral);transform:translateY(-1px) scale(var(--phi-size-range-thumb-scale))}", xr = k(yr), kr = ({ $el: e, value: t, min: r, max: o, step: i }) => {
  const n = C((l, c) => {
    c.stopPropagation(), t.value = l, e.dispatchEvent(new Event("input"));
  }, [e, t]);
  return /* @__PURE__ */ s(
    wr,
    {
...
}), $r = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M2.5 4v3h5v12h3V7h5V4h-13zm19 5h-9v3h3v7h3v-7h3V9z" })
] }), Cr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M7 15v2h10v-2H7zm-4 6h18v-2H3v2zm0-8h18v-2H3v2zm4-6v2h10V7H7zM3 3v2h18V3H3z" })
] }), Sr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M3 21h18v-2H3v2zm0-4h18v-2H3v2zm0-4h18v-2H3v2zm0-4h18V7H3v2zm0-6v2h18V3H3z" })
] }), Hr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M15 15H3v2h12v-2zm0-8H3v2h12V7zM3 13h18v-2H3v2zm0 8h18v-2H3v2zM3 3v2h18V3H3z" })
] }), Mr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M3 21h18v-2H3v2zm6-4h12v-2H9v2zm-6-4h18v-2H3v2zm6-4h12V7H9v2zM3 3v2h18V3H3z" })
] }), Tr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 -960 960 960", width: "24px", children: /* @__PURE__ */ s("path", { d: "M560-240 320-480l240-240 56 56-184 184 184 184-56 56Z" }) }), Er = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 -960 960 960", width: "24px", children: /* @__PURE__ */ s("path", { d: "M504-480 320-664l56-56 240 240-240 240-56-56 184-184Z" }) }), Vr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M19 13H5v-2h14v2z" })
] }), qr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12 19 6.41z" })
] }), Ar = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", "enable-background": "new 0 0 24 24", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("g", { children: /* @__PURE__ */ s("rect", { fill: "none", height: "24", width: "24", x: "0" }) }),
  /* @__PURE__ */ s("g", { children: /* @__PURE__ */ s("g", { children: [
    /* @__PURE__ */ s("polygon", { points: "20,7 20.94,4.94 23,4 20.94,3.06 20,1 19.06,3.06 17,4 19.06,4.94" }),
    /* @__PURE__ */ s("polygon", { points: "8.5,7 9.44,4.94 11.5,4 9.44,3.06 8.5,1 7.56,3.06 5.5,4 7.56,4.94" }),
    /* @__PURE__ */ s("polygon", { points: "20,12.5 19.06,14.56 17,15.5 19.06,16.44 20,18.5 20.94,16.44 23,15.5 20.94,14.56" }),
    /* @__PURE__ */ s("path", { d: "M17.71,9.12l-2.83-2.83C14.68,6.1,14.43,6,14.17,6c-0.26,0-0.51,0.1-0.71,0.29L2.29,17.46c-0.39,0.39-0.39,1.02,0,1.41 l2.83,2.83C5.32,21.9,5.57,22,5.83,22s0.51-0.1,0.71-0.29l11.17-11.17C18.1,10.15,18.1,9.51,17.71,9.12z M14.17,8.42l1.41,1.41 L14.41,11L13,9.59L14.17,8.42z M5.83,19.59l-1.41-1.41L11.59,11L13,12.41L5.83,19.59z" })
  ] }) })
] }), Pr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
...
] }), Wr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z" })
] }), Lr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M20 4v12H8V4h12m0-2H8c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h12c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zm-8.5 9.67l1.69 2.26 2.48-3.1L19 15H9zM2 6v14c0 1.1.9 2 2 2h14v-2H4V6H2z" })
] }), Nr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M19 13h-6v6h-2v-6H5v-2h6V5h2v6h6v2z" })
] }), jr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M19 12v7H5v-7H3v7c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2v-7h-2zm-6 .67l2.59-2.58L17 11.5l-5 5-5-5 1.41-1.41L11 12.67V3h2v9.67z" })
] }), Br = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 -960 960 960", width: "24px", children: /* @__PURE__ */ s("path", { d: "M320-200h280v-400h-80q-28 0-46 14t-43 41q-20 22-46.5 45.5T320-465v265Zm-80 80v-346q-52-14-86-56t-34-98q0-53 30.5-94t78.5-57q23-48 68.5-78T400-879q35 0 65.5 12t55.5 32q10-2 19-3.5t20-1.5q66 0 113 47t47 113q0 22-5.5 42T698-600h62q33 0 56.5 23.5T840-520v240q0 33-23.5 56.5T760-200h-80v80H240Zm-40-500q0 33 23.5 56.5T280-540q32 0 54.5-21t46.5-47q25-27 56.5-49.5T520-680h120q0-33-23.5-56.5T560-760q-25 0-42 6.5l-17 6.5-31-26q-11-9-28.5-17.5T400-799q-32 0-58.5 17T301-736l-14 30-32 11q-25 8-40 28.5T200-620Zm480 340h80v-240h-80v240Zm-360 80h280-280Z" }) }), Fr = () => /* @__PURE__ */ s("svg", { class: "phi-icon", xmlns: "http://www.w3.org/2000/svg", height: "24", viewBox: "0 0 24 24", width: "24", children: [
  /* @__PURE__ */ s("path", { d: "M0 0h24v24H0V0z", fill: "none" }),
  /* @__PURE__ */ s("path", { d: "M9 16.2L4.8 12l-1.4 1.4L9 19 21 7l-1.4-1.4L9 16.2z" })
] }), Dr = {
  beer: Br,
  text: $r,
  "align-center": Cr,
...
}, Or = ".phi-icon{display:inline;width:auto;height:1em;vertical-align:-.11em;fill:currentColor}", Rr = k(Or), Ir = ({ icon: e }) => /* @__PURE__ */ s(Ur, { icon: e.value }), Zr = () => z(Ir, "phi-icon", {
  adoptedStyleSheets: [$, Rr],
  properties: [{
    name: "icon",
    attribute: { name: "icon", type: T }
  }]
}), Yr = ({ color: e }) => /* @__PURE__ */ s("span", { class: "phi-color-swatch", style: { background: e } }), Gr = ".phi-color-swatch{display:inline-block;width:calc(1.6 * var(--phi-fontsize-icon-md));height:var(--phi-fontsize-icon-md);border:1px solid var(--phi-color-border);border-radius:var(--phi-radius-sm)}", Jr = k(Gr), Kr = ({ color: e }) => /* @__PURE__ */ s(Yr, { color: e.value }), Qr = () => z(Kr, "phi-color-swatch", {
  adoptedStyleSheets: [$, Jr],
  properties: [{
    name: "color",
    attribute: { name: "color", type: T }
  }]
}), eo = () => {
  typeof window < "u" && (ht(), mt(), yt(), Ct(), Et(), Bt(), Rt(), Jt(), er(), nr(), sr(), _r(), br(), zr(), Zr(), Qr());
};
export {
  eo as default
};
