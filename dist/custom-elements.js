...
function j() {
  for (var t, e, r, i, l, o, a, s = 1; S.length; ) S.length > s && S.sort(ie), t = S.shift(), s = S.length, t.__d && (r = void 0, l = (i = (e = t).__v).__e, o = [], a = [], e.__P && ((r = k({}, i)).__v = i.__v + 1, f.vnode && f.vnode(r), G(e.__P, r, i, e.__n, e.__P.namespaceURI, 32 & i.__u ? [l] : null, o, l ?? P(i), !!(32 & i.__u), a), r.__v = i.__v, r.__.__k[r.__i] = r, _e(o, r, a), r.__e != l && se(r)));
  j.__r = 0;
}
function pe(t, e, r, i, l, o, a, s, c, p, _) {
  var n, g, h, b, m, v, d = i && i.__k || ae, u = e.length;
  for (c = me(r, e, d, c, u), n = 0; n < u; n++) (h = r.__k[n]) != null && (g = h.__i == -1 ? N : d[h.__i] || N, h.__i = n, v = G(t, h, g, l, o, a, s, c, p, _), b = h.__e, h.ref && g.ref != h.ref && (g.ref && Y(g.ref, null, h), _.push(h.ref, h.__c || b, h)), m == null && b != null && (m = b), 4 & h.__u || g.__k === h.__k ? c = ce(h, c, t) : typeof h.type == "function" && v !== void 0 ? c = v : b && (c = b.nextSibling), h.__u &= -7);
  return r.__e = m, c;
}
function me(t, e, r, i, l) {
  var o, a, s, c, p, _ = r.length, n = _, g = 0;
  for (t.__k = new Array(l), o = 0; o < l; o++) (a = e[o]) != null && typeof a != "boolean" && typeof a != "function" ? (c = o + g, (a = t.__k[o] = typeof a == "string" || typeof a == "number" || typeof a == "bigint" || a.constructor == String ? E(null, a, null, null, null) : I(a) ? E(O, { children: a }, null, null, null) : a.constructor == null && a.__b > 0 ? E(a.type, a.props, a.key, a.ref ? a.ref : null, a.__v) : a).__ = t, a.__b = t.__b + 1, s = null, (p = a.__i = ye(a, r, c, n)) != -1 && (n--, (s = r[p]) && (s.__u |= 2)), s == null || s.__v == null ? (p == -1 && (l > _ ? g-- : l < _ && g++), typeof a.type != "function" && (a.__u |= 4)) : p != c && (p == c - 1 ? g-- : p == c + 1 ? g++ : (p > c ? g-- : g++, a.__u |= 4))) : t.__k[o] = null;
  if (n) for (o = 0; o < _; o++) (s = r[o]) != null && (2 & s.__u) == 0 && (s.__e == i && (i = P(s)), de(s, s));
  return i;
}
function ce(t, e, r) {
  var i, l;
  if (typeof t.type == "function") {
    for (i = t.__k, l = 0; i && l < i.length; l++) i[l] && (i[l].__ = t, e = ce(i[l], e, r));
    return e;
  }
...
function ye(t, e, r, i) {
  var l, o, a = t.key, s = t.type, c = e[r];
  if (c === null && t.key == null || c && a == c.key && s == c.type && (2 & c.__u) == 0) return r;
  if (i > (c != null && (2 & c.__u) == 0 ? 1 : 0)) for (l = r - 1, o = r + 1; l >= 0 || o < e.length; ) {
    if (l >= 0) {
      if ((c = e[l]) && (2 & c.__u) == 0 && a == c.key && s == c.type) return l;
      l--;
    }
    if (o < e.length) {
      if ((c = e[o]) && (2 & c.__u) == 0 && a == c.key && s == c.type) return o;
      o++;
    }
  }
  return -1;
...
function G(t, e, r, i, l, o, a, s, c, p) {
  var _, n, g, h, b, m, v, d, u, C, w, D, z, J, L, A, W, y = e.type;
  if (e.constructor != null) return null;
  128 & r.__u && (c = !!(32 & r.__u), o = [s = e.__e = r.__e]), (_ = f.__b) && _(e);
  e: if (typeof y == "function") try {
    if (d = e.props, u = "prototype" in y && y.prototype.render, C = (_ = y.contextType) && i[_.__c], w = _ ? C ? C.props.value : _.__ : i, r.__c ? v = (n = e.__c = r.__c).__ = n.__E : (u ? e.__c = n = new y(d, w) : (e.__c = n = new F(d, w), n.constructor = y, n.render = we), C && C.sub(n), n.props = d, n.state || (n.state = {}), n.context = w, n.__n = i, g = n.__d = !0, n.__h = [], n._sb = []), u && n.__s == null && (n.__s = n.state), u && y.getDerivedStateFromProps != null && (n.__s == n.state && (n.__s = k({}, n.__s)), k(n.__s, y.getDerivedStateFromProps(d, n.__s))), h = n.props, b = n.state, n.__v = e, g) u && y.getDerivedStateFromProps == null && n.componentWillMount != null && n.componentWillMount(), u && n.componentDidMount != null && n.__h.push(n.componentDidMount);
    else {
      if (u && y.getDerivedStateFromProps == null && d !== h && n.componentWillReceiveProps != null && n.componentWillReceiveProps(d, w), !n.__e && n.shouldComponentUpdate != null && n.shouldComponentUpdate(d, n.__s, w) === !1 || e.__v == r.__v) {
      ...
      n.componentWillUpdate != null && n.componentWillUpdate(d, n.__s, w), u && n.componentDidUpdate != null && n.__h.push(function() {
        n.componentDidUpdate(h, b, m);
      });
    }
    if (n.context = w, n.props = d, n.__P = t, n.__e = !1, z = f.__r, J = 0, u) {
      for (n.state = n.__s, n.__d = !1, z && z(e), _ = n.render(n.props, n.state, n.context), L = 0; L < n._sb.length; L++) n.__h.push(n._sb[L]);
      n._sb = [];
    } else do
      n.__d = !1, z && z(e), _ = n.render(n.props, n.state, n.context), n.state = n.__s;
    while (n.__d && ++J < 25);
    n.state = n.__s, n.getChildContext != null && (i = k(k({}, i), n.getChildContext())), u && !g && n.getSnapshotBeforeUpdate != null && (m = n.getSnapshotBeforeUpdate(h, b)), A = _, _ != null && _.type === O && _.key == null && (A = he(_.props.children)), s = pe(t, I(A) ? A : [A], e, r, i, l, o, a, s, c, p), n.base = e.__e, e.__u &= -161, n.__h.length && a.push(n), v && (n.__E = n.__ = null);
  } catch (M) {
    if (e.__v = null, c || o != null) if (M.then) {
      for (e.__u |= c ? 160 : 128; s && s.nodeType == 8 && s.nextSibling; ) s = s.nextSibling;
      o[o.indexOf(s)] = null, e.__e = s;
    } else for (W = o.length; W--; ) q(o[W]);
    else e.__e = r.__e, e.__k = r.__k;
    f.__e(M, e, r);
  }
  else o == null && e.__v == r.__v ? (e.__k = r.__k, e.__e = r.__e) : s = e.__e = ke(r.__e, e, r, i, l, o, a, c, p);
  return (_ = f.diffed) && _(e), 128 & e.__u ? void 0 : s;
}
function _e(t, e, r) {
...
function ke(t, e, r, i, l, o, a, s, c) {
  var p, _, n, g, h, b, m, v = r.props, d = e.props, u = e.type;
  if (u == "svg" ? l = "http://www.w3.org/2000/svg" : u == "math" ? l = "http://www.w3.org/1998/Math/MathML" : l || (l = "http://www.w3.org/1999/xhtml"), o != null) {
    for (p = 0; p < o.length; p++) if ((h = o[p]) && "setAttribute" in h == !!u && (u ? h.localName == u : h.nodeType == 3)) {
      t = h, o[p] = null;
      break;
    }
  }
  ...
  if (u == null) v === d || s && t.data == d || (t.data = d);
    ...
    if (o = o && U.call(t.childNodes), v = r.props || N, !s && o != null) for (v = {}, p = 0; p < t.attributes.length; p++) v[(h = t.attributes[p]).name] = h.value;
    for (p in v) if (h = v[p], p != "children") {
      if (p == "dangerouslySetInnerHTML") n = h;
      else if (!(p in d)) {
        if (p == "value" && "defaultValue" in d || p == "checked" && "defaultChecked" in d) continue;
        $(t, p, null, h, l);
      }
    }
    for (p in d) h = d[p], p == "children" ? g = h : p == "dangerouslySetInnerHTML" ? _ = h : p == "value" ? b = h : p == "checked" ? m = h : s && typeof h != "function" || v[p] === h || $(t, p, h, v[p], l);
    if (_) s || n && (_.__html == n.__html || _.__html == t.innerHTML) || (t.innerHTML = _.__html), e.__k = [];
    else if (n && (t.innerHTML = ""), pe(e.type == "template" ? t.content : t, I(g) ? g : [g], e, r, i, u == "foreignObject" ? "http://www.w3.org/1999/xhtml" : l, o, a, o ? o[0] : r.__k && P(r, 0), s, c), o != null) for (p = o.length; p--; ) q(o[p]);
    s || (p = "value", u == "progress" && b == null ? t.removeAttribute("value") : b != null && (b !== t[p] || u == "progress" && !b || u == "option" && b != v[p]) && $(t, p, b, v[p], l), p = "checked", m != null && m != t[p] && $(t, p, m, v[p], l));
  }
  return t;
}
function Y(t, e, r) {
...
function H(t, e, r) {
  var i, l, o, a;
  e == document && (e = document.documentElement), f.__ && f.__(t, e), l = (i = typeof r == "function") ? null : r && r.__k || e.__k, o = [], a = [], G(e, t = (!i && r || e).__k = T(O, null, [t]), l || N, N, e.namespaceURI, !i && r ? [r] : l ? null : e.firstChild ? U.call(e.childNodes) : null, o, !i && r ? r : l ? l.__e : e.firstChild, i, a), _e(o, t, a);
}
function ue(t, e) {
  H(t, e, ue);
}
...
}, F.prototype.render = O, S = [], ne = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, ie = function(t, e) {
...
function ee(t, e, r, i, l, o) {
  e || (e = {});
  var a, s, c = e;
  if ("ref" in c) for (s in c = {}, e) s == "ref" ? a = e[s] : c[s] = e[s];
  var p = { type: t, props: c, key: r, ref: a, __k: null, __: null, __b: 0, __e: null, __c: null, constructor: void 0, __v: --Se, __i: -1, __u: 0, __source: l, __self: o };
  if (typeof t == "function" && (a = t.defaultProps)) for (s in a) c[s] === void 0 && (c[s] = a[s]);
...
const Pe = ({
  ...
  class r extends HTMLElement {
    ...
    parseAttribute(o, a, s) {
      var c, p;
      if (!(s && ((c = this._initialProps) != null && c.hasOwnProperty(o))) && (p = e.attributes) != null && p[o]) {
        const _ = e.attributes[o], n = "parse" in _ ? _.parse : _;
    ...
    connectedCallback() {
      ...
      for (let _ = 0; _ < o.length; _++)
        this.parseAttribute(o[_].name, o[_].value, !0);
      const s = this._initialProps ?? {}, c = Object.fromEntries(
        (e.slots ?? []).map((_) => [_, T(re, { name: _ }, null)])
      ), p = { $element: this, ...s, ...c };
      this._vdom = T(t, p, T(re, { name: void 0 }, null)), (this.hasAttribute("hydrate") ? ue : H)(this._vdom, this._root);
    }
  ...
  return x(r, "observedAttributes", Object.keys(e.attributes ?? {})), x(r, "formAssociated", !!e.formAssociated), (e.properties ?? []).forEach((i) => {
    ...
    Object.defineProperty(r.prototype, i, {
      ...
      set(c) {
        this.updateProp(i, c), a && this.setAttribute(i, a(c)), l && this._internals && this._internals.setFormValue(c);
      }
    });
  }), r;
};
