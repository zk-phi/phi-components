...
function se(t, e, r, a, i, n, l, s, _, p, c) {
  var o, u, h, v, m, g, f = a && a.__k || ie, d = e.length;
  for (_ = ve(r, e, f, _, d), o = 0; o < d; o++) (h = r.__k[o]) != null && (u = h.__i == -1 ? H : f[h.__i] || H, h.__i = o, g = Y(t, h, u, i, n, l, s, _, p, c), v = h.__e, h.ref && u.ref != h.ref && (u.ref && J(u.ref, null, h), c.push(h.ref, h.__c || v, h)), m == null && v != null && (m = v), 4 & h.__u || u.__k === h.__k ? _ = pe(h, _, t) : typeof h.type == "function" && g !== void 0 ? _ = g : v && (_ = v.nextSibling), h.__u &= -7);
  return r.__e = m, _;
}
function ve(t, e, r, a, i) {
  var n, l, s, _, p, c = r.length, o = c, u = 0;
  for (t.__k = new Array(i), n = 0; n < i; n++) (l = e[n]) != null && typeof l != "boolean" && typeof l != "function" ? (_ = n + u, (l = t.__k[n] = typeof l == "string" || typeof l == "number" || typeof l == "bigint" || l.constructor == String ? E(null, l, null, null, null) : I(l) ? E(W, { children: l }, null, null, null) : l.constructor == null && l.__b > 0 ? E(l.type, l.props, l.key, l.ref ? l.ref : null, l.__v) : l).__ = t, l.__b = t.__b + 1, s = null, (p = l.__i = me(l, r, _, o)) != -1 && (o--, (s = r[p]) && (s.__u |= 2)), s == null || s.__v == null ? (p == -1 && (i > c ? u-- : i < c && u++), typeof l.type != "function" && (l.__u |= 4)) : p != _ && (p == _ - 1 ? u-- : p == _ + 1 ? u++ : (p > _ ? u-- : u++, l.__u |= 4))) : t.__k[n] = null;
...
function Y(t, e, r, a, i, n, l, s, _, p) {
  var c, o, u, h, v, m, g, f, d, P, w, F, A, K, N, z, O, y = e.type;
  if (e.constructor != null) return null;
  128 & r.__u && (_ = !!(32 & r.__u), n = [s = e.__e = r.__e]), (c = b.__b) && c(e);
  e: if (typeof y == "function") try {
    if (f = e.props, d = "prototype" in y && y.prototype.render, P = (c = y.contextType) && a[c.__c], w = c ? P ? P.props.value : c.__ : a, r.__c ? g = (o = e.__c = r.__c).__ = o.__E : (d ? e.__c = o = new y(f, w) : (e.__c = o = new U(f, w), o.constructor = y, o.render = ke), P && P.sub(o), o.props = f, o.state || (o.state = {}), o.context = w, o.__n = a, u = o.__d = !0, o.__h = [], o._sb = []), d && o.__s == null && (o.__s = o.state), d && y.getDerivedStateFromProps != null && (o.__s == o.state && (o.__s = k({}, o.__s)), k(o.__s, y.getDerivedStateFromProps(f, o.__s))), h = o.props, v = o.state, o.__v = e, u) d && y.getDerivedStateFromProps == null && o.componentWillMount != null && o.componentWillMount(), d && o.componentDidMount != null && o.__h.push(o.componentDidMount);
    else {
      if (d && y.getDerivedStateFromProps == null && f !== h && o.componentWillReceiveProps != null && o.componentWillReceiveProps(f, w), !o.__e && o.shouldComponentUpdate != null && o.shouldComponentUpdate(f, o.__s, w) === !1 || e.__v == r.__v) {
        for (e.__v != r.__v && (o.props = f, o.state = o.__s, o.__d = !1), e.__e = r.__e, e.__k = r.__k, e.__k.some(function(M) {
          M && (M.__ = e);
        }), F = 0; F < o._sb.length; F++) o.__h.push(o._sb[F]);
        o._sb = [], o.__h.length && l.push(o);
        break e;
      }
      o.componentWillUpdate != null && o.componentWillUpdate(f, o.__s, w), d && o.componentDidUpdate != null && o.__h.push(function() {
        o.componentDidUpdate(h, v, m);
      });
    }
    if (o.context = w, o.props = f, o.__P = t, o.__e = !1, A = b.__r, K = 0, d) {
    ...
    while (o.__d && ++K < 25);
    o.state = o.__s, o.getChildContext != null && (a = k(k({}, a), o.getChildContext())), d && !u && o.getSnapshotBeforeUpdate != null && (m = o.getSnapshotBeforeUpdate(h, v)), z = c, c != null && c.type === W && c.key == null && (z = ce(c.props.children)), s = se(t, I(z) ? z : [z], e, r, a, i, n, l, s, _, p), o.base = e.__e, e.__u &= -161, o.__h.length && l.push(o), g && (o.__E = o.__ = null);
  } catch (M) {
...
function ye(t, e, r, a, i, n, l, s, _) {
  var p, c, o, u, h, v, m, g = r.props, f = e.props, d = e.type;
  if (d == "svg" ? i = "http://www.w3.org/2000/svg" : d == "math" ? i = "http://www.w3.org/1998/Math/MathML" : i || (i = "http://www.w3.org/1999/xhtml"), n != null) {
    for (p = 0; p < n.length; p++) if ((h = n[p]) && "setAttribute" in h == !!d && (d ? h.localName == d : h.nodeType == 3)) {
      t = h, n[p] = null;
      break;
    }
  }
  if (t == null) {
    ...
    t = document.createElementNS(i, d, f.is && f), s && (b.__m && b.__m(e, n), s = !1), n = null;
  }
  if (d == null) g === f || s && t.data == f || (t.data = f);
  else {
    ...
    for (p in f) h = f[p], p == "children" ? u = h : p == "dangerouslySetInnerHTML" ? c = h : p == "value" ? v = h : p == "checked" ? m = h : s && typeof h != "function" || g[p] === h || L(t, p, h, g[p], i);
    if (c) s || o && (c.__html == o.__html || c.__html == t.innerHTML) || (t.innerHTML = c.__html), e.__k = [];
    else if (o && (t.innerHTML = ""), se(e.type == "template" ? t.content : t, I(u) ? u : [u], e, r, a, d == "foreignObject" ? "http://www.w3.org/1999/xhtml" : i, n, l, n ? n[0] : r.__k && C(r, 0), s, _), n != null) for (p = n.length; p--; ) G(n[p]);
    s || (p = "value", d == "progress" && v == null ? t.removeAttribute("value") : v != null && (v !== t[p] || d == "progress" && !v || d == "option" && v != g[p]) && L(t, p, v, g[p], i), p = "checked", m != null && m != t[p] && L(t, p, m, g[p], i));
  }
  return t;
}
function J(t, e, r) {
...
const te = (t) => T("slot", t), Se = (t) => {
  ...
  class l extends HTMLElement {
    ...
    registerProperty(c) {
      const o = c.name, u = n === o, h = () => this._props[o].value, v = (g, f) => {
        g !== this._props[o].value && (this._props[o] = {
          get value() {
            return g;
          },
          set value(d) {
          ...
          _dirty: f || this._props[o]._dirty
        }, u && this._internals && this._internals.setFormValue(Se(g)), this.rerender());
      };
      ...
      if (this._props[o] = {
        ...
        const g = (f) => {
          var d;
          (d = this._props[o]) != null && d._dirty || v(c.attribute.type(f), !1);
        };
    ...
    attributeChangedCallback(c, o, u) {
      this._attributeChangeHooks[c] && this._attributeChangeHooks[c].forEach((h) => h(u));
    }
  }
...
}, Ne = ({ danger: t, variant: e, icon: r, children: a }) => /* @__PURE__ */ R(He, { icon: r, danger: t.value, variant: e.value, children: a }), Le = () => Ae(Ne, "phi-button", {
  ...
  properties: [{
    ...
    name: "variant",
    /* これ initValue: "primary" とかにしても、 attr で "default" が指定されてると
     * そっちになってしまう。多分ブラウザが勝手に attr -> prop にマッピングしている？ */
    /* 今回のケースでは大きな問題はないが、複雑なパーサーを要求するケースでは怪しい */
    /* なにが悪さしているのだろう */
